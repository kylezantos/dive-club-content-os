# Editorial Analyst Execution

## Task Description
Extract editorial preferences from brain dumps
...
Results should be formatted for saving to: `/voice-patterns/editorial-preferences.md`
